...
import { Code, Lightbulb, Users, Sparkles, ChevronRight, Award } from "lucide-react"
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        >
          ...
          <p className="text-xl text-gray-300 max-w-4xl mx-auto">
            IdeaJam is <span className="text-[#1cb683] font-medium">SIH-themed innovation challenge</span>, designed to
            prepare students for the <span className="text-[#1cb683]">Smart India Hackathon</span>. Over three
            competitive rounds, participants will present, pitch, and perfect their solutions to real-world problems.
          </p>
        </motion.div>
            ...
            <GlassCard className="p-8 relative overflow-hidden group">
              ...
              <div className="space-y-4 text-gray-300">
                <p>
                  ...
                  ensuring you experience the same challenge structure, judging criteria, and innovation-driven
                  atmosphere.
                </p>
                <p>
                  It’s not just about coding — it’s about{" "}
                  <span className="text-[#1cb683] font-medium">creativity, feasibility, and impact</span>. Your
                  solutions must be innovative and directly aligned with official SIH problem statements.
                </p>
                <p>
            ...
            {features.map((feature, index) => (
              ...
              >
                <GlassCard className="p-6 h-full text-center group relative overflow-hidden">
                  <div
                    className={`absolute inset-0 bg-gradient-to-br from-transparent to-${feature.color}/10 opacity-0 group-hover:opacity-100 transition-opacity duration-300`}
                  />
                  <feature.icon
                    className={`w-8 h-8 ${feature.color} mx-auto mb-4 group-hover:scale-110 group-hover:drop-shadow-[0_0_15px_currentColor] transition-all duration-300`}
                  />
